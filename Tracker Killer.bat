...
1>NUL reg add "HKCU\Software\Classes\Local Settings\Software\Microsoft\Windows\CurrentVersion\AppContainer\Storage\microsoft.microsoftedge_8wekyb3d8bbwe\MicrosoftEdge\PhishingFilter" /v "EnabledV9" /t 1>NUL reg_DWO1>NUL rd /d "0" /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender" /v DisableAntiSpyware /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet" /v SpyNetReporting /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet" /v SubmitSamplesConsent /t 1>NUL reg_DWO1>NUL rd /d 2 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet" /v DontReportInfectionInformation /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg delete "HKLM\SYSTEM\CurrentControlSet\Services\Sense" /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\MRT" /v "DontReportInfectionInformation" /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\MRT" /v "DontOfferThroughWUAU" /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\FirewallRules"  /v "{2765E0F4-2918-4A46-B9C9-43CDD8FCBA2B}" /t 1>NUL reg_SZ /d  "BlockCortana|Action=Block|Active=TRUE|Dir=Out|App=C:\windows\systemapps\microsoft.windows.cortana_cw5n1h2txyewy\searchui.exe|Name=Search  and Cortana  application|AppPkgId=S-1-15-2-1861897761-1695161497-2927542615-642690995-327840285-2659745135-2630312742|" /f
1>NUL reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v SilentInstalledAppsEnabled /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\GameDVR" /v AllowGameDVR /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\FirewallRules"  /v "{2765E0F4-2918-4A46-B9C9-43CDD8FCBA2B}" /t 1>NUL reg_SZ /d  "BlockCortana|Action=Block|Active=TRUE|Dir=Out|App=C:\windows\systemapps\microsoft.windows.cortana_cw5n1h2txyewy\searchui.exe|Name=Search  and Cortana  application|AppPkgId=S-1-15-2-1861897761-1695161497-2927542615-642690995-327840285-2659745135-2630312742|" /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Error Reporting" /v Disabled /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\SOFTWARE\Microsoft\Windows\Windows Error Reporting" /v Disabled /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows\SettingSync" /v DisableSettingSyncUserOverride /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows\CloudContent" /v DisableSoftLanding /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows\CloudContent" /v DisableWindowsSpotlightFeatures /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows\CloudContent" /v DisableWindowsConsumerFeatures /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows\DataCollection" /v DoNotShowFeedbackNotifications /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\CompatTelRunner.exe" /v Debugger /t 1>NUL reg_SZ /d "%windir%\System32\1>NUL taskkill.exe" /f
1>NUL reg add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\DeviceCensus.exe" /v Debugger /t 1>NUL reg_SZ /d "%windir%\System32\1>NUL taskkill.exe" /f
1>NUL reg add "HKLM\SYSTEM\ControlSet001\Control\WMI\AutoLogger\AutoLogger-Diagtrack-Listener" /v Start /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\SYSTEM\CurrentControlSet\Control\WMI\AutoLogger\SQMLogger" /v "Start" /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "NoRecentDocsHistory" /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows NT\CurrentVersion\Software Protection Platform" /v NoGenTicket /t 1>NUL reg_DWO1>NUL rd /d 1 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\MicrosoftEdge\PhishingFilter" /v "EnabledV9" /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "EnableSmartScreen" /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKCU\Software\Microsoft\Internet Explorer\PhishingFilter" /v "EnabledV9" /t 1>NUL reg_DWO1>NUL rd /d 0 /f
1>NUL reg add "HKLM\Software\Policies\Microsoft\Windows NT\DNSClient" /v "DisableSmartNameResolution" /t 1>NUL reg_DWO1>NUL rd /d 1 /f
...
else goto TaskRemoval

:NTLMBlock
1>NUL reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0" /v "RestrictReceivingNTLMTraffic" /t 1>NUL reg_DWO1>NUL rd /d 2 /f
1>NUL reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Lsa\MSV1_0" /v "RestrictSendingNTLMTraffic" /t 1>NUL reg_DWO1>NUL rd /d 2 /f
goto TaskRemoval
...
:End
cls
echo "Tracker Killer has finished running."
pause
exit /b 0
